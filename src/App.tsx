...
function MainAppContent() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F17] text-[#f8fafc] flex flex-col selection:bg-cyan-500/30 selection:text-cyan-200 relative overflow-x-hidden">
      {/* Global Modals */}
      <KeyModal />
      <ApiKeySuccessModal />
      <CreateProfileModal />
      ...
      {activeTab === 'landing' ? (
        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          <footer className="border-t border-cyan-500/20 py-6 bg-[#02050f]/80 backdrop-blur-xl text-center text-xs text-slate-400 relative z-10">
